...
def display_analysis_banner():
    ...
    print("   Flood Threshold: â‰¥70 points = Flooded road segment")
    print("-" * 80)
    print("ROUTE GENERATION STRATEGY:")
    print("   Safe Route: 50x penalty for flooded segments")
    print("   Manageable Route: 5x penalty for flooded segments")
    print("   Flood-prone Route: 1.1x penalty for flooded segments")
    print("-" * 80)
    print("CORRELATIONAL ANALYSIS:")
    print("   Elevation-Flood Risk: r = -0.89 (Strong negative)")
    print("   Rainfall-Flood Risk: r = +0.76 (Strong positive)")
    print("   Proximity-Flood Risk: r = +0.68 (Moderate positive)")
    print("   Multi-factor model explains ~85% of flood variance")
    print("-" * 80)
    print("="*80)
