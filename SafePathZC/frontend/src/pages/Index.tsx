...
const Index = () => {
  ...
  return (
    <div className="h-screen bg-gray-50 font-sans overflow-hidden">
      ...
      {/* Clear Simulation Button - positioned in top-left for visibility */}
      {simulationScenario && (
        <button
          onClick={handleClearSimulation}
          className="fixed top-16 left-4 z-50 px-4 py-2 text-sm bg-red-600 text-white rounded-lg shadow-lg hover:bg-red-700 flex items-center gap-2 transition-all"
        >
