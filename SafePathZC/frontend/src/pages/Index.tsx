...
const Index = () => {
  ...
  return (
    <div className="h-screen bg-gray-50 font-sans overflow-hidden">
      ...
      {/* Clear Simulation Button - positioned bottom-left above More Options button */}
      {simulationScenario && (
        <button
          onClick={handleClearSimulation}
          className="fixed bottom-16 left-4 z-40 px-4 py-2.5 text-sm font-medium bg-red-600 text-white rounded-lg shadow-lg hover:bg-red-700 transition-all"
        >
          Clear Simulation
        </button>
      )}
