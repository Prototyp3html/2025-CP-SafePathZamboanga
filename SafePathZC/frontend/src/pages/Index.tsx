...
const Index = () => {
  ...
  return (
    <div className="h-screen bg-gray-50 font-sans overflow-hidden">
      ...
      {/* Clear Simulation Button - positioned under nav bar */}
      {simulationScenario && (
        <button
          onClick={handleClearSimulation}
          className="fixed top-12 left-4 z-50 px-3 py-2 text-xs sm:text-sm bg-red-600 text-white rounded-lg shadow-lg hover:bg-red-700 flex items-center gap-2 transition-all"
        >
