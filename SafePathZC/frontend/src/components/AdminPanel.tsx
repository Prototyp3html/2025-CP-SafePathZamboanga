...
export const AdminPanel: React.FC<AdminPanelProps> = ({ isOpen, onClose }) => {
  ...
  const handlePrintReports = () => {
    ...
    const printContent = `
      ...
      <html>
        <head>
          <title>SafePath ZC - Reports Export</title>
          <style>
            ...
            .urgency { padding: 4px 8px; border-radius: 4px; font-size: 10px; font-weight: bold; }
            ...
            .footer { margin-top: 30px; text-align: center; font-size: 11px; color: #666; border-top: 2px solid #e5e7eb; padding-top: 15px; }
            @media print {
        ...
        <body>
          ...
          <div class="no-print" style="margin-top: 30px; text-align: center;">
            <button onclick="window.print()" style="padding: 10px 30px; background: #2563eb; color: white; border: none; border-radius: 6px; cursor: pointer; font-size: 14px; margin-right: 10px;">
              Print Report
            </button>
            <button onclick="window.close()" style="padding: 10px 30px; background: #6b7280; color: white; border: none; border-radius: 6px; cursor: pointer; font-size: 14px;">
              Close
            </button>
          </div>
        </body>
        ...
        <div className="flex-1 overflow-hidden">
          ...
          {activeTab === "analytics" && (
            <div className="h-full overflow-y-auto p-6">
              ...
              {/* Reports by Urgency and Time Distribution */}
