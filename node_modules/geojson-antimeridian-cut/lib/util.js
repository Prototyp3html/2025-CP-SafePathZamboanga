...
exports.antimeridianIntersect = exports.crossingPoints = exports.straddlesAntimeridian = exports.bringLonWithinBounds = void 0;
 ...
 */
const bringLonWithinBounds = lon => {
  let rtn = lon;
...
exports.bringLonWithinBounds = bringLonWithinBounds;

const straddlesAntimeridian = ([lonARaw], [lonBRaw]) => {
  ...
  return lonA > 0 ? lonB < -(180 - lonA) : lonA < -(180 - lonB);
};
/**
...
exports.straddlesAntimeridian = straddlesAntimeridian;

const crossingPoints = points => {
  const rtn = [];
...
exports.crossingPoints = crossingPoints;
...
const antimeridianIntersect = ([lonA, latA], [lonB, latB]) => {
...
exports.antimeridianIntersect = antimeridianIntersect;